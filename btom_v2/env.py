...
class BTomEnvV2:
    def __init__(self, scenario_id: str, seed: int, max_turns: int = 30) -> None:
        supported = {"C1_fully_observable", "C2_partial_observable", "C4_communication_delay", "C4b_costly_communication_delay", "C4c_wrong_branch_communication_delay", "C5_false_belief_injection", "C5b_costly_false_belief", "C6_resource_allocation"}
